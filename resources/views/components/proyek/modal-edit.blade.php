<div id="modalEdit" class="hidden fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-screen overflow-y-auto transform transition-all">
        ...
        <div class="p-6">
            <form id="formEditProyek" onsubmit="event.preventDefault(); updateProyek();" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="editKode" name="kode" placeholder="Masukkan kode proyek"
                    ...
                    <span id="errorEditKode" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="editNama" name="nama" placeholder="Masukkan nama proyek"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorEditNama" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="editTanggal" name="tanggal"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorEditTanggal" class="text-red-500 text-sm mt-1 block"></span>
                </div>
