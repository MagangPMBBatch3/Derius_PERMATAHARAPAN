<div id="modalAdd" class="hidden fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-screen overflow-y-auto transform transition-all">
        <div class="sticky top-0 bg-gradient-to-r from-blue-600 to-indigo-600 p-6 rounded-t-2xl">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-2xl font-bold text-white">Tambah Proyek Baru</h2>
                </div>
        ...
        <div class="p-6">
            <form id="formAddProyek" onsubmit="event.preventDefault(); createProyek();" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="addKode" name="kode" placeholder="Masukkan kode proyek"
                    ...
                    <span id="errorAddKode" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="addNama" name="nama" placeholder="Masukkan nama proyek"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorAddNama" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="addTanggal" name="tanggal"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorAddTanggal" class="text-red-500 text-sm mt-1 block"></span>
                </div>
