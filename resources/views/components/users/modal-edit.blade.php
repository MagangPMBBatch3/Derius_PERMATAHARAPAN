<div id="modalEditUser" class="hidden fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-screen overflow-y-auto transform transition-all">
        ...
        <div class="p-6">
            <form id="formEditUser" onsubmit="event.preventDefault(); updateUser();" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="editUserName" name="name" placeholder="Masukkan nama lengkap"
                    ...
                    <span id="errorEditUserName" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="editUserEmail" name="email" placeholder="Masukkan alamat email"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorEditUserEmail" class="text-red-500 text-sm mt-1 block"></span>
                </div>
                ...
                <div>
                    ...
                    <input type="password" id="editUserPassword" name="password" placeholder="Masukkan password baru"
                           class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    <span id="errorEditUserPassword" class="text-red-500 text-sm mt-1 block"></span>
                </div>
